...
public class ActivitiConfig {
	...
	public @Bean SpringProcessEngineConfiguration processEngineConfiguration() throws IOException {
	...
	public @Bean ProcessEngineFactoryBean processEngine(SpringProcessEngineConfiguration processEngineConfiguration) {
		ProcessEngineFactoryBean factory = new ProcessEngineFactoryBean();
		factory.setProcessEngineConfiguration(processEngineConfiguration);
		return factory;
	}

	public @Bean RepositoryService repositoryService(ProcessEngine processEngine) {
	...
	public @Bean ManagementService managementService(ProcessEngine processEngine) {
